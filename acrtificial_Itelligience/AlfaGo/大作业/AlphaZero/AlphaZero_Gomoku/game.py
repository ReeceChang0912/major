...
class Board(object):
    ...
    def __init__(self, **kwargs):
        ...
        self.states = {} # board states, key:move as location on the board, value:player as pieces type 这是棋盘上的状态 
        self.n_in_row = int(kwargs.get('n_in_row', 5)) # need how many pieces in a row to win 在一行中，需要5个连在一起才能赢
    ...
    def init_board(self, start_player=0):
        ...
        self.states = {} # board states, key:move as location on the board, value:player as pieces type 在棋盘上的状态
        self.last_move = -1
...
class Game(object):
    ...
    def start_self_play(self, player, is_shown=0, temp=1e-3):
        ...
        while(1):
            ...
            if end:
                # winner from the perspective of the current player of each state 出现赢家
